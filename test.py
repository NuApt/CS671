...
main_folder = '/Iris_Segmentation/Iris_Segmentation'

# Path to mask and image folders

image_folder = './Iris_Segmentation/CASIA-V4-Lamp_images_L_R_ALL'
mask_folder = './Iris_Segmentation/CASIA-V4-Lamp_mask_similar'
...
train_dataset_gen = Generator(image_list[:1900], mask_list[:1900], processor)
...
for epoch in range(10):
    for inputs in train_ds:
        ...
        with open("print.txt", mode = 'a', newline = "") as file:
            file.write("inner loss: " + str(loss)+ "\n")
